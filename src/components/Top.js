                ...
                <div className='container'>
                    <div className="d-flex flex-column py-5">
                        ...
                        <nav className="my-2 my-md-0 mr-md-3 text-center">
                            ...
                            <a className="p-2 text-light" href="/articles">Articles</a>
                            <a className="p-2 text-light" href="/about-us">About us</a>
                            <a className="p-2 text-light" href="/contact-us">Contact us</a>
                        </nav>
                    </div>
                </div>
